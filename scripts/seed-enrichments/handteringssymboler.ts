...
export function handteringssymbolerEnrichment(): Block[] {
  return [
    callout(
      "Kort sagt",
      "Symbolene skal fortelle hvordan kolliet skal håndteres og lagres. De er et supplement til god emballasje, ikke en erstatning for riktig pakking.",
    ),
    textBlock("Hva er ISO 780?", "h2"),
    ...paragraphsToBlocks(
    ...
    textBlock("Slik bør symbolene brukes", "h2"),
    {
      _type: "checklist",
      _key: key(),
      items: [
