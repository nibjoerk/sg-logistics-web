...
export const seaworthyPacking: Article = {
  ...
  body: [
    {
      ...
      tone: "info",
      label: "Kort sagt",
      html: "<p>En seaworthy transportpakke skal beskytte varen gjennom hele planlagt transportløp og samtidig gjøre godset mulig å håndtere, sikre, merke og dokumentere på en trygg måte.</p>",
    },
    {
      heading: "Hva er seaworthy packing?",
      text:
    ...
    {
      heading: "Grunnregler før du velger emballasje",
      text:
    ...
    {
      heading: "Emballasjetyper for sjøtransport",
      text:
    ...
    {
      _type: "checklist",
      heading: "Målet med innvendig beskyttelse",
    ...
    {
      heading: "Materialvalg, gjenbruk og ISPM 15",
      text:
    ...
    {
      heading: "ISPM 15 for treemballasje",
      text:
    ...
    {
      heading: "Merking og viktig lastinformasjon",
      text:
    ...
    {
      heading: "Hvorfor merking betyr noe",
      text:
    ...
    {
      heading: "Internasjonale håndteringssymboler",
      text:
    ...
    },
    {
      _type: "callout",
      tone: "tip",
      label: "Se egen symbolguide",
      html: "<p>Vi har samlet symbolene og forklaringene i en egen artikkel om <a href=\"/kjekt-a-vite/handteringssymboler\">håndteringssymboler på gods</a>.</p>",
    },
    {
      _type: "checklist",
      heading: "Sjekkliste for avsender",
      items: checklist,
    },
    {
      _type: "callout",
      tone: "tip",
      label: "Praktisk råd",
      html: "<p>Dokumenter emballering og sikring med bilder. Det gjør det lettere å lære av avvik og gir bedre grunnlag ved skade, reklamasjon eller forsikringssak.</p>",
    },
    {
      _type: "linkCards",
...
/** Sanity mirror used on /kjekt-a-vite/s-seaworthy-packing during migration review. */
export const seaworthyPackingMirror: Article = {
  ...seaworthyPacking,
  title: `# ${seaworthyPacking.title}`,
  slug: "s-seaworthy-packing",
  href: "/kjekt-a-vite/s-seaworthy-packing",
